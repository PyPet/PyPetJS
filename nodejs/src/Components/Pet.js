...
function ComponentPet(pet) {
  ...
  alignItems = "center" > {" "}<Grid item xs = {4}><center>
               <section id = "Pet__Photo">
               <img src = {dog1} alt = "" width = "70%">
               </img>
            </section></center>
        </Grid>< Divider
  ...
  style =
  {
    { width: 3, backgroundColor: "#bdc3c7" }
  } />
        <Grid item xs>
          <center>
          ...
          KiloGramos<
              ...
              Agites de cola(Por Minuto)</h3>
            </section>
      </center>
        </Grid>
      </Grid>
      <Divider style={{ height: 3, backgroundColor: "#bdc3c7" }} />
      <section id = "Pet__Btns">< ButtonGroup
  variant = "contained"
  color = "primary"
