...
ReactDOM.render(
  <React.StrictMode style={styleBG}>
        <div className="typewriter1">
          ...
          onLoopDone={() =>
          (document.getElementsByClassName("AppHidden")[0].className="App", document.getElementsByClassName("typewriter1")[0].innerHTML="")
          }
        />
    </div><div className="AppHidden">
    <App/>
    </div>
  </React.StrictMode>,
